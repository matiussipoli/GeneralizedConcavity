...
cd 'C:\Users\Guilherme\Google Drive\Doutorado\Estudos\Generalized Conc on Bilinear Strc\Matlab'
...
src = sqrt(muCoef'*inv(pSig)*muCoef); % right side of the initial inequality  
...
%%%%%%%%%%%
%Defining the feasible set of optimization problem or initial point
%%%%%%%%%%%
